...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_2_label_1, "SC2");
    lv_label_set_long_mode(ui->screen_2_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_2_label_1, 70, 124);
    ...
    lv_obj_set_style_text_font(ui->screen_2_label_1, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
